...
public function getMascotasDisponiblesParaAsociacion()
{
    ...
    $builder->select('m.nro_registro, m.nombre, m.especie, m.raza, m.fecha_alta'); // Ajusta los campos que necesites
    ...
    // Queremos mascotas cuyo nro_registro NO ESTÉ en la lista de mascotas con asociación activa
